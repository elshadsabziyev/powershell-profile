...
############                       https://github.com/elshadsabziyev/powershell-profile.git.                         ############
############                                                                                                         ############
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!#
############                                                                                                         ############
...
if ($repo_root_Override){
    ...
    $repo_root = "https://github.com/elshadsabziyev"
}
...
if (Get-Command -Name "Get-Theme_Override" -ErrorAction SilentlyContinue){
    ...
    oh-my-posh init pwsh --config https://raw.githubusercontent.com/JanDeDobbeleer/oh-my-posh/refs/heads/main/themes/M365Princess.omp.json | Invoke-Expression
}
